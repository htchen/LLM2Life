...
| Lab 3 習慣追蹤 + 上線 | ⚠️ 同 Lab 1 |

**四段洞見反而幾乎全部存活**：規格就是工作、自動化門檻、驗證能力，都還講得通。

**但整場的核心體驗死了。** 投影片第 10–11 頁（「你可能用過的 AI 是這樣 → 然後你就卡住了」
對比「Claude Code 是這樣 → **差別在於它有手**」）正是在嘲笑複製貼上這件事。
免費版等於把學員放回那張投影片嘲笑的位置。
...
> **而非程式背景的學員停頓很多**——聽講師講話、讀步驟、發呆、等別人。
