...
三小時實作工作坊的完整教材。對象是**沒有程式背景**的高中教師。
從教學現場的真實問題出發，完成發想、規劃、實作與驗證，做出一個可操作的最小版本——
**而且做完之後它是你自己的**：有網址、改壞了回得去、明年還在、交得給同事。

AI 產生第一版這件事，現在很多工具都做得到。這門課教的是**做完之後**的那一段：
